...
namespace AcademiaDoZe._Application.Tests.AplicationTests
{
    public class ColaboradorApplicationTests
    {
        ...
        public async Task ColaboradorService_Integracao_Adicionar_Obter_Atualizar_Remover()
        {
            ...
            var caminhoFoto = Path.Combine("C:\\Users\\rafas\\OneDrive\\Documentos\\Trabalhos Faculdade\\Trabalhos Desenv Sistemas 2\\AcademiaDoZe\\AcademiaDoZe. Application.Tests\\AplicationTests\\foto_teste.png");
            ArquivoDTO foto = new();
            ...
            try
            {
                ...
                // Act - Obter por cpf
                var obtidos = await colaboradorService.ObterPorCpfAsync(criado.Cpf);
                
                // Assert - obter
                var obtido = obtidos.FirstOrDefault(c => c.Id == criado.Id);
